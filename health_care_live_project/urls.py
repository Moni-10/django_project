...
urlpatterns = [
    ...
    path('service/department.html', views.department_view, name='department'), 
    path('service/doctor.html', views.doctor_view, name='doctor'),
    path('department.html', views.department_view, name='department'),
    path('doctor.html', views.doctor_view, name='doctor'),
]
